...
| `continuum-jdbc` | JDBC persistence — certified on PostgreSQL, MySQL, MariaDB, Oracle |
...
durable persistence on a certified platform (PostgreSQL, MySQL, MariaDB, Oracle);
