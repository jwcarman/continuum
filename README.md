...
| `continuum-jdbc` | JDBC persistence — certified on PostgreSQL, MySQL, MariaDB, Oracle, SQL Server |
...
durable JDBC persistence; with `continuum-mongo` and a `MongoClient`,
MongoDB; otherwise the starter falls back to the
